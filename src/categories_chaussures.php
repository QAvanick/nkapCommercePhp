...
// Récupérer les catégories de chaussures
$sql = "SELECT * FROM categories WHERE titre LIKE '%chaussures%'";
$stmt = $pdo->prepare($sql);
$stmt->execute();

$categories = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Récupérer les produits associés aux catégories de chaussures
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body custom-width">
                    <h2 class="card-title text-danger">Catégories de Chaussures</h2>
                    <div class="list-group">
                        <?php if (empty($categories)): ?>
                            <p>Aucune catégorie disponible pour les chaussures.</p>
                        <?php else: ?>
                    ...
                    <h2 class="card-title text-danger mt-4">Produits de Chaussures</h2>
                    <div class="list-group">
                        <?php if (empty($products)): ?>
                            <p>Aucun produit disponible pour les chaussures.</p>
                        <?php else: ?>
