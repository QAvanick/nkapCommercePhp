        ...
        <div class="col-md-10"> 
            <div class="card"  style="border-radius: 10px; box-shadow: 0 0 150px rgba(0, 0, 0, 0.1);">
                <div class="row g-0"   style="background: #fff;  border-radius: 10px; box-shadow: 0 0 150px rgba(0, 0, 0, 0.1); border-left: 5px solid black;">
                    ...
                    <div class="col-md-6">
                        <img src="https://www.shutterstock.com/image-photo/businessman-email-icon-on-virtual-600nw-2325396425.jpg" alt="Image de contact" class="img-fluid" style="height: 100%; width: 100%; object-fit: cover; border-radius: 0 10px 10px 0;">
                    </div>
                </div>
            </div>
        </div>
